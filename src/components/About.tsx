    ...
    return (
        <ContentBox>
            ...
            <ContentBoxCarouselTwoColumns>
                ...
                <ContentBoxText>
                    <p><ContentBoxSubTitle>{t('infrastructure.title')}</ContentBoxSubTitle>{t('infrastructure.description')}</p>
                    <p><ContentBoxSubTitle>{t('computer-vision.title')}</ContentBoxSubTitle>{t('computer-vision.description')}</p>
                </ContentBoxText>
            </ContentBoxCarouselTwoColumns>
        </ContentBox>)
}